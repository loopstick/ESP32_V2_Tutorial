...
void loop() {
  ...
  pixels.show();   // Update the NeoPixel to show the color
    Serial.print("RED"); // print color to serial monitor
  ...
  // Set the first pixel (index 0) to greem (R, G, B)
  pixels.setPixelColor(0, pixels.Color(0, 255, 0)); 
  pixels.show();   // Update the NeoPixel to show the color
    Serial.print("GREEN"); // print color to serial monitor
  delay(500);      // Wait for 500 milliseconds
  ...
  // Set the first pixel (index 0) to blue (R, G, B)
  pixels.setPixelColor(0, pixels.Color(0, 0, 255)); 
  pixels.show();   // Update the NeoPixel to show the color
    Serial.print("BLUE"); // print color to serial monitor
  delay(500);      // Wait for 500 milliseconds
